        ...
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                className="text-4xl flex items-center justify-center h-14 w-14 rounded-full"
        ...
        <div className="space-y-4 mt-4">
              ...
              <CardContent className="p-4">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-semibold text-lg">Why & Identity</h3>
                  </div>
                  {showMeaning ? (
                    ...
                    {habit.why && (
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="font-medium text-sm">Why this matters to me:</h4>
                        </div>
                    ...
                    {habit.identityStatement && (
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="font-medium text-sm">Who I'm becoming:</h4>
                        </div>
                        <p className="text-muted-foreground pl-6 leading-relaxed italic">
                          "{habit.identityStatement}"
                        </p>
                      </div>
                    )}
          ...
          <Card>
            <CardContent className="p-4 space-y-3">
              <h3 className="font-semibold">Habit Details</h3>
